  ...
  .category-btn:hover {
    ...
    <div class="row">
      <div class="col-4">
        ...
        <p>100</p>
        <button class="addToCart" onclick="addToCart('White Couple Coders', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\featured 1.jpeg', 'plus')">Add to Cart</button>
      </div>
      ...
      <div class="col-4">
        ...
        <p>100</p>
        <button class="addToCart" onclick="addToCart('Black Couple Coders', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\featured 2.jpeg', 'plus')">Add to Cart</button>
      </div>
       ...
       <div class="col-4">
        ...
        <p>150</p>
        <button class="addToCart" onclick="addToCart('Black Couple Coders (With Brand Name)', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\featured 3.jpeg', 'plus')">Add to Cart</button>
      </div>
       ...
       <div class="col-4">
         ...
         <p>150</p>
         <button class="addToCart" onclick="addToCart('White Couple Coders (With Brand Name)', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\featured 4.jpeg', 'plus')">Add to Cart</button>
       </div>
      ...
      <div class="col-4">
        ...
        <p>100</p>
        <button class="addToCart" onclick="addToCart('Cheezy Fire Wall', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\1.png', 'plus')">Add to Cart</button>
      </div>
      ...
      <div class="col-4">
        ...
        <p>100</p>
        <button class="addToCart" onclick="addToCart('Wormm Keller', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\2.png', 'plus')">Add to Cart</button>
      </div>
       ...
       <div class="col-4">
        ...
        <p>150</p>
        <button class="addToCart" onclick="addToCart('Elite Phishing', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\3.png', 'plus')">Add to Cart</button>
      </div>
       ...
       <div class="col-4">
         ...
         <p>150</p>
         <button class="addToCart" onclick="addToCart('Alpha Trojan', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\4.png', 'plus')">Add to Cart</button>
       </div>
     </div>
      ...
      <div class="row">
        ...
        <div class="col-4">
          ...
          <p>100</p>
          <button class="addToCart" onclick="addToCart('Teamplay Coders', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\6.png', 'plus')">Add to Cart</button>
        </div>
        ...
        <div class="col-4">
          ...
          <p>150</p>
          <button class="addToCart" onclick="addToCart('Final Robocap Boss', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\7.png', 'plus')">Add to Cart</button>
        </div>
        ...
        <div class="col-4">
          ...
          <p>150</p>
          <button class="addToCart" onclick="addToCart('Ninja Thiefaklong', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\8.png', 'plus')">Add to Cart</button>
        </div>
      </div>
       <div class="row">
         <div class="col-4">
           ...
           <p>100</p>
           <button class="addToCart" onclick="addToCart('Darling at home', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\9.png', 'plus')">Add to Cart</button>
         </div>
         ...
         <div class="col-4">
           ...
           <p>100</p>
           <button class="addToCart" onclick="addToCart('Proffesor X-Code', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\10.png', 'plus')">Add to Cart</button>
         </div>
         ...
         <div class="col-4">
           ...
           <p>150</p>
           <button class="addToCart" onclick="addToCart('Happy Skatertask', 100, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\11.png', 'plus')">Add to Cart</button>
         </div>
         ...
         <div class="col-4">
           ...
           <p>150</p>
           <button class="addToCart" onclick="addToCart('Pythonatics', 130, 'C:\\Users\\selyo\\OneDrive\\Pictures\\website\\12.png', 'plus')">Add to Cart</button>
         </div>
         <div class="col-4">
        ...
        <div class="col-4">
          ...
          <p>130</p>
          <button class="addToCart" onclick="addToCart('Sure No Error', 100, 'C:\\Users\\selyo\\Downloads\\Sure No Error.jpg', 'plus')">Add to Cart</button>
        </div>
        <div class="col-4">
          ...
          <p>130</p>
          <button class="addToCart" onclick="addToCart('Html loves u', 130, 'C:\\Users\\selyo\\Downloads\\Html loves u.jpg', 'plus')">Add to Cart</button>
        </div>
        <div class="col-4">
          ...
          <p>130</p>
          <button class="addToCart" onclick="addToCart('Javaparel', 130, 'C:\\Users\\selyo\\Downloads\\Javaparel.jpg', 'plus')">Add to Cart</button>
        </div>
        <div class="col-4">
          ...
          <p>130</p>
          <button class="addToCart" onclick="addToCart('Watdahil', 130, 'C:\\Users\\selyo\\Downloads\\Watdahil.jpg', 'plus')">Add to Cart</button>
        </div>
     </div>
    </div>
  </div>
