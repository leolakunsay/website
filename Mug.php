  ...
  div img{
    ...
    <body>
      ...
      <div class="category-container minimized">
        <a href="All Products.php" class="category-btn" onclick="selectCategory('All Products')">All Products</a>
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-4">
                  ...
                  <p>130</p>
                  <button class="addToCart" onclick="addToCart('Sure No Error', 130, 'C:\\Users\\selyo\\Downloads\\Sure No Error.jpg', 'plus')">Add to Cart</button>
                </div>
            </div>
